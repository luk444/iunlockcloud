...
import { Search, HelpCircle, CreditCard, Smartphone, AlertCircle, Shield } from 'lucide-react';
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 mt-10 fade-in">
      ...
      <div className="space-y-4 mt-6">
        {[
          "Professional blacklist removal service for reported devices",
          "Advanced validation system with automatic device detection",
          "Secure processing with external verification tools"
        ].map((text, index) => (
          <div key={index} className="p-4 bg-red-50 border border-red-100 rounded-lg transform transition-all duration-300 hover:scale-102">
