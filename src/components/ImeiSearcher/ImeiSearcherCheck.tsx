...
const ImeiSearcherCheck: React.FC<ImeiSearcherProps> = ({ onSearch, onSelectDevice }) => {
    ...
    <div className="max-w-2xl mx-auto px-4 py-8 mt-4 fade-in">
      ...
      <div className="card">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-800">Check Device</h2>
        </div>
...
export default ImeiSearcherCheck;